...
STATES_INPUT = './extract/state_abbr.csv'
CSV_INPUT = './extract/Export.csv'
MARKETS_OUTPUT = './tarsform/markets.csv'
CITIES_OUTPUT = './tarsform/cities.csv'
STATES_OUTPUT = './tarsform/states.csv'
CATGEORIES_OUTPUT = './tarsform/categories.csv'
MARKETS_CATGEORIES_OUTPUT = './tarsform/markets_categories.csv'
